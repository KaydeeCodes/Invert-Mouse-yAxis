...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        RunShellCommand("xinput --set-prop 15 'Coordinate Transformation Matrix' 1 0 0  0 -1 1  0 0 1"); //invert mouse X only!
        ...
        RunShellCommand("xinput --set-prop 15 'Coordinate Transformation Matrix' 1 0 0 0 1 0 0 0 1"); //restore mouse
